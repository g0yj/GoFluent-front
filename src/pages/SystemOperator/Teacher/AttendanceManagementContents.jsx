...
// 강사관리(1depth) > 출석률(2depth)
const AttendanceManagementContents = () => {
    ...
    <section className="ui-contents-wrap max-width flex1">
      <div className="ui-contents-inner">
        <div className="ui-location-wrap">
          <div className="ui-location-title">출석률</div>
        ...
        <div className="sp-mt-10">
          ...
          {<Table status={"Y"} year={date.year} month={date.month} />}
        </div>
      </div>
    </section>
  );
...
export default AttendanceManagementContents;
