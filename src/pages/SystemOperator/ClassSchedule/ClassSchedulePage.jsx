...
const ClassSchedulePage = ({language, isReport}) => {
    ...
    <>
      <nav className="ui-lnb-wrap">
        <div className="ui-lnb-inner">
          ...
          <NavLink className="link active" to="/admin/operator/class-schedule" onClick={() => onRefresh("/admin/operator/class-schedule")}>
            강의시간표
          </NavLink>
          ):(
            <NavLink className="link active" to="/admin/teacher/daily-schedule" onClick={() => onRefresh("/admin/teacher/daily-schedule")}>
            강의시간표
          </NavLink>
          )}
        </div>
